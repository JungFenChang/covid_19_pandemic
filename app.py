...
with gr.Blocks() as global_map_tap:
    ...
    with gr.Column():
        ...
        global_map = gr.Plot()
    global_map_tap.load(fn=filter_global_map,
                        inputs=countries,
                        outputs=global_map)
...
with gr.Blocks() as country_time_series_tap:
    ...
    country_time_series_tap.load(fn=filter_time_series,
            inputs=country,
    ...
    country_time_series_tap.load(fn=filter_time_series,
            inputs=country,
            outputs=plt_doses)
demo = gr.TabbedInterface([global_map_tap, country_time_series_tap],
